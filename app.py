...
st.markdown(
    ...
    <style>
      ...
      .metric-card .value { font-weight:800; font-size:1.2rem; margin-top:.2rem; }
      ...
      .section-title { margin:.4rem 0 .5rem; font-weight: 800; font-size:1.05rem; color:var(--ink); }
...
MODEL_PATH = Path("omakase_model_ohe.pkl")
META_PATH  = Path("preprocess_metadata_ohe.json")
